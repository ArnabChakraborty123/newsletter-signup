...
app.use(express.static("public"));// providing the path of our static files,then we should be refer to these static files by relative URL   , and that is relative to public folder.
